...
public class ManterFuncionarioExibirCommand extends ManterFuncionarioCommand {
    ...
    public void executar(ManterFuncionarioPresenter presenter) {
        ...
        presenter.getView().getCheckBoxFuncionarioDoMes().setSelected(funcionario.isFuncionarioDoMes());
        presenter.getView().getTxtFormatedFieldAdmissao().setText(funcionario.getAdmissao().
